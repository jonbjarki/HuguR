...
export default function Bubble({title, content, isRight, btnText, btnLink}: BubbleProps) {
    ...
    return (
        <fieldset className="m-auto border-2 rounded-larger border-red-600 w-4/6 h-fit px-8 pt-8 pb-12 flex items-center flex-col lg:flex-row text-2xl text-center md:text-left font-light font-sans">
