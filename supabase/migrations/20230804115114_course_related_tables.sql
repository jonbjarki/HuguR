...
--     constraint weeks_course_id_fkey foreign key (course_id) references courses (id) on delete cascade,
--     constraint weeks_unique_course_id_number unique (course_id, number)
-- );
