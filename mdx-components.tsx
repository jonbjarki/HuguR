...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    p: (props) => <p className="text-lg my-1 font-serif flex-col md:flex-row flex justify-start items-center min-w-[50%]" {...props} />,
    a: (props) => <a className="italic underline" {...props} />,
    ul: (props) => (
      <ul className="list-disc list-inside mb-4 ul" {...props} />
    ),
